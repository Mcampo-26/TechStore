...
export default function ProductoDetalleClient({ product }: ProductoDetalleClientProps) {
  ...
  return (
    <>
      ...
      <div className={`max-w-7xl mx-auto px-4 sm:px-6 pt-24 sm:pt-32 pb-24 transition-all duration-1000 ${
        showMasterLoader ? 'opacity-0 scale-95 blur-xl' : 'opacity-100 scale-100 blur-0'
      }`}>
