        ...
        <div className="max-w-7xl mx-auto px-4 w-full flex items-center justify-between gap-4">
          ...
          <div className="flex items-center">
            <ul className="hidden md:flex items-center gap-6 text-[10px] font-black uppercase tracking-[0.2em]">
              ...
              {/* PANEL ADMIN Y DASHBOARD (Solo logueados) */}
              {mounted && isLoggedIn && (
                <>
                  <li>
                    <Link href="/admin/dashboard" className="group flex items-center gap-2 px-5 py-2.5 rounded-xl transition-all duration-300 border border-slate-500/20 hover:bg-blue-600/10 text-[9px] font-black"
                      style={{ color: isDarkMode ? '#f8fafc' : '#0f172a' }}>
          ...
          <div className="p-5 mt-auto border-t" style={{ backgroundColor: isDarkMode ? '#161e2f' : '#f8fafc', borderColor: isDarkMode ? '#1e293b' : '#f1f5f9' }}>
            {mounted && isLoggedIn ? (
              <div className="space-y-3">
                {/* Dashboard en Mobile */}
                <Link href="/admin/dashboard" onClick={() => setIsMobileMenuOpen(false)} className="flex items-center justify-center gap-3 py-4 rounded-2xl border border-blue-600/20 font-black uppercase text-[10px]" style={{ color: isDarkMode ? '#f8fafc' : '#0f172a' }}>
